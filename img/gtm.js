...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__d",
      "vtp_elementSelector":"a.a-accept",
  ...
  "tags":[{
      ...
      "vtp_autoLinkDomains":"reducaps.net.br",
      ...
      "vtp_conversionId":"818221297",
      "vtp_currencyCode":"BRL",
      "vtp_conversionLabel":"G558CJSZhpsBEPGhlIYD",
      "vtp_rdp":false,
      "vtp_url":["macro",4],
      ...
      "vtp_linkerDomains":"reducaps.com.br, reducaps.net.br, formulaemagrecimento.typeform.com",
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_hotjar_site_id":"1406953",
      "tag_id":23
    },{
      "function":"__cvt_11620532_447",
      "metadata":["map"],
      "once_per_event":true,
      "vtp_addRevenue":false,
      "vtp_accountId":"1066956",
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",5],
      "arg1":"\/jejum-intermitente"
    },{
      "function":"_re",
      "arg0":["macro",5],
      "arg1":"\/pagamento-pendente"
    },{
      "function":"_re",
      "arg0":["macro",2],
      "arg1":"\/100-lowcarb"
  ...
  "rules":[
    [["if",0],["add",0,2,7,9,10,11,12,13]],
    [["if",0,1],["add",1,8]],
    [["if",0,3],["unless",2,4,5,6,7],["add",3]],
    [["if",0,8],["add",4]],
    [["if",0,9],["add",4]],
    [["if",0,10],["add",5]],
    [["if",11,12],["add",6]],
...
return null},Df=!1;if(I.querySelectorAll)try{var Ef=I.querySelectorAll(":root");Ef&&1==Ef.length&&Ef[0]==I.documentElement&&(Df=!0)}catch(a){}var Af=Df;var Hd={},Sf=null,Tf=Math.random();Hd.w="GTM-KDGRNKT";Hd.Rb="5e1";Hd.Td="";var Uf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Vf="www.googletagmanager.com/gtm.js";
var Wf=Vf,Xf=null,Yf=null,Zf=null,$f="//www.googletagmanager.com/a?id="+Hd.w+"&cv=428",ag={},bg={},cg=function(){var a=Sf.sequence||0;Sf.sequence=a+1;return a};
...
b){return!1},removeItem:function(a){}};var cm=function(){try{Ce(this,"logging")}catch(c){return}if(!console)return;for(var a=Array.prototype.slice.call(arguments,0),b=0;b<a.length;b++)a[b]=qb(a[b],this.m);console.log.apply(console,a);};var dm={},em={};dm.getItem=function(a){var b=null;return b};dm.setItem=function(a,b){};
...
e.vtp_enableLinkId&&x("require","linkid","linkid.js");x("set","hitCallback",function(){var P=g&&g.hitCallback;Da(P)&&P();e.vtp_gtmOnSuccess()});if("TRACK_EVENT"==e.vtp_trackType){}else if("TRACK_SOCIAL"==e.vtp_trackType){}else if("TRACK_TRANSACTION"==e.vtp_trackType){}else if("TRACK_TIMING"==
